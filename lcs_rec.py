#!/usr/bin/env python3
"""
Longest Common Subsequence solution using recursive techniques:

- Naive recursion; LCS(A, B, j, k)
- Inbuilt caching; LCSCACHE(A, B, j, k)
- Hashmap memoization; LCSMEMO(A, B, j, k, L)
- Bottom-up iterated hashmap memoization; LCSBU(A, B, j, k, L)

Bottom-up iteration is surprisingly faster than top-down iteration, on average.
